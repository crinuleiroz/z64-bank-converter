...
class Bankmeta:
    ...
    def to_dict(self):
        return {
            ...
            "field": [
                ...
                {"name": "Cache Load Type", "datatype": "uint8", "ispointer": "0", "isarray": "0", "meaning": "None", "defaultval": "2", "value": str(self.cache_load_type)},
                {"name": "Sample Bank ID 1", "datatype": "uint8", "ispointer": "0", "isarray": "0", "meaning": "None", "defaultval": "0", "value": str(self.table_id_1)},
                {"name": "Sample Bank ID 2", "datatype": "uint8", "ispointer": "0", "isarray": "0", "meaning": "None", "defaultval": "255", "value": str(self.table_id_2)},
    ...
    def from_yaml(cls, bankmeta_dict: dict):
        ...
        self.sample_medium   = resolve_enum_value(AudioStorageMedium, bankmeta_dict.get('storage medium', "CART"))
        self.cache_load_type = resolve_enum_value(CacheLoadType, bankmeta_dict.get('cache load type', "TEMPORARY"))
        self.table_id_1      = bankmeta_dict.get('sample bank id 1', 1)
        self.table_id_2      = resolve_enum_value(SampleBankID, bankmeta_dict.get('sample bank id 2', "NO_SAMPLE_BANK"))
    ...
    def to_yaml(self) -> dict:
        return {
            ...
            "cache load type": resolve_enum_name(CacheLoadType, self.cache_load_type),
            "sample bank id 1": resolve_enum_name(SampleBankID, self.table_id_1),
            "sample bank id 2": resolve_enum_name(SampleBankID, self.table_id_2),
    ...
    @property
    def attributes(self):
        return {'NUM_INST': self.num_instruments, 'NUM_DRUM': self.num_drums, 'NUM_SFX': self.num_effects, 'ATnum': self.table_id_1}
